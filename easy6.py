...
def easy(window, ans5, qu5, qu4, qu3, qu2, qu1):
    ...
    if instance == 1:
        question.setText('''6. Ποιο από τα παρακάτω ποτάμια
διασχίζει την πόλη του Λονδίνου;''')
    elif instance == 2:
        question.setText('''6. Ποιο από τα παρακάτω βουνά είναι
το ψηλότερο στην Ευρώπη;''')
    elif instance == 3:
        question.setText('''6. Ποια από τις παρακάτω πόλεις είναι
η πρωτεύουσα της Αυστρίας;''')
    ...
    def setcorrecttext():
        if instance == 1:
            dania.setText("Α) Σηκουάνας")
            kroatia.setText("Β) Ρήνος")
            norway.setText("Γ) Τάμεσης")
            poland.setText("Δ) Δούναβης")
        if instance == 2:
            dania.setText("Α) Έλμπρους")
            kroatia.setText("Β) Μάττερχορν")
            norway.setText("Γ) Λευκό Όρος")
            poland.setText("Δ) Κιλιμάντζαρο")
        if instance == 3:
            dania.setText("Α) Βιέννη")
            kroatia.setText("Β) Βουδαπέστη")
            norway.setText("Γ) Βέρνη")
            poland.setText("Δ) Λευκωσία")

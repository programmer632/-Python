...
def easy(window, ans3, qu3, qu2, qu1):
    ...
    if instance == 1:
        question.setText('''4. Ποια είναι η πιο πυκνοκατοικημένη
χώρα της Ευρώπης;''')
    elif instance == 2:
        question.setText('''4. Ποιο είναι το μικρότερο κράτος της Ευρώπης;''')
    elif instance == 3:
        question.setText('''4. Ποια χώρα συνορεύει με τις περισσότερες
άλλες χώρες στην Ευρώπη;''')
    ...
    def setcorrecttext():
        if instance == 1:
            dania.setText("Α) Ολλανδία")
            kroatia.setText("Β) Γερμανία")
            norway.setText("Γ) Βέλγιο")
            poland.setText("Δ) Μονακό")
        if instance == 2:
            dania.setText("Α) Λιχτενστάιν")
            kroatia.setText("Β) Άγιος Μαρίνος")
            norway.setText("Γ) Βατικανό")
            poland.setText("Δ) Ανδόρα")
        if instance == 3:
            dania.setText("Α) Γαλλία")
            kroatia.setText("Β) Γερμανία")
            norway.setText("Γ) Ιταλία")
            poland.setText("Δ) Ελβετία")

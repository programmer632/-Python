...
def easy(window, ans6, qu6, qu5, qu4, qu3, qu2, qu1):
    ...
    if instance == 1:
        question.setText('''7. Σε ποια χώρα βρίσκεται η περιοχή της Τοσκάνης;''')
    elif instance == 2:
        question.setText('''7. Ποια είναι η μεγαλύτερη λίμνη της Ευρώπης;''')
    elif instance == 3:
        question.setText('''7. Ποια χώρα συνορεύει με τη Λετονία;''')
    ...
    def setcorrecttext():
        if instance == 1:
            ...
            norway.setText("Γ) Ελλάδα")
            poland.setText("Δ) Ισπανία")
        if instance == 2:
            dania.setText("Α) Μπάλατον")
            kroatia.setText("Β) Βάνερν")
            norway.setText("Γ) Λαντόγκα")
            poland.setText("Δ) Κόμο")
        if instance == 3:
            dania.setText("Α) Λιθουανία")
            kroatia.setText("Β) Πολωνία")
            norway.setText("Γ) Φινλανδία")
            poland.setText("Δ) Μολδαβία")
